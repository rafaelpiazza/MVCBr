...
begin
  ...
  begin
    ...
    v := it.Value;
    case it.datatype of
      ftString,ftFixedChar,ftWideString,ftFixedWideChar : v := QuotedStr(v);
      ftDate,ftDateTime : v := quotedStr(  DateToISO8601( StrToDateTimeDef(v,0) )  );
...
begin
  p:='';
  Result := FBaseURL + FServicePreffix + FService;
