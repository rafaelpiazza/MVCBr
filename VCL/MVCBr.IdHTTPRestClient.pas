...
type
  ...
  private
    ...
    procedure SetResourceSuffix(const Value: string);
  ...
  published
    ...
    Property ResourceSuffix: string read FResourceSuffix
      write SetResourceSuffix;
...
begin
  result := FBaseURL + FResourceSuffix + FResource;
end;
...
procedure TIdHTTPRestClient.SetResourceSuffix(const Value: string);
begin
